...
def test_drift_state_supersedes_everything(workspace_with_feature):
    ...
    with patch("canopy.management.feature_state.review.find_pull_request", side_effect=_no_pr), \
         patch("canopy.management.feature_state.review.get_review_comments", side_effect=_no_comments):
...
def test_needs_work_with_actionable_comments(workspace_with_feature):
    ...
    with patch("canopy.management.feature_state.review.find_pull_request", return_value=fake_pr), \
